...
function buildChatPrompt(message, history, mode = "chat", targetLanguage = "english") {
  ...
  if (mode === "topic") {
    return [
      ...
      `5. If the student asks how to say or translate a Chinese phrase into ${language.label}, do not repeat that Chinese phrase, do not ask for confirmation, and do not ask whether they want a formal or informal version unless they explicitly request variants. Directly use ${labelEnglish} with the most common natural ${language.label} expression, then ${labelMeaning} with the Chinese meaning.`,
  ...
  return [
    ...
    `If the user asks how to say or translate a Chinese phrase into ${language.label}, do not repeat that Chinese phrase, do not ask for confirmation, and do not ask whether they want a formal or informal version unless they explicitly request variants. Directly output ${labelEnglish} with the most common natural ${language.label} expression, then ${labelMeaning} with the Chinese meaning.`,
